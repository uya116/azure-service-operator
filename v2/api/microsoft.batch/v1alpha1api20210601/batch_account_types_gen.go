...
func (batchAccount *BatchAccount) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected storage:microsoft.batch/v1alpha1api20210601storage/BatchAccount but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-microsoft-batch-azure-com-v1alpha1api20210601-batchaccount,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.batch.azure.com,resources=batchaccounts,verbs=create;update,versions=v1alpha1api20210601,name=default.v1alpha1api20210601.batchaccounts.microsoft.batch.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-batch-azure-com-v1alpha1api20210601-batchaccount,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.batch.azure.com,resources=batchaccounts,verbs=create;update,versions=v1alpha1api20210601,name=validate.v1alpha1api20210601.batchaccounts.microsoft.batch.azure.com,admissionReviewVersions=v1beta1
...
func (autoStorageBaseProperties *AutoStorageBaseProperties) AssignPropertiesFromAutoStorageBaseProperties(source *v1alpha1api20210601storage.AutoStorageBaseProperties) error {
	...
	if source.NodeIdentityReference != nil {
		...
		if err != nil {
			return errors.Wrap(err, "populating NodeIdentityReference from NodeIdentityReference, calling AssignPropertiesFromComputeNodeIdentityReference()")
		}
		autoStorageBaseProperties.NodeIdentityReference = &nodeIdentityReference
	} else {
...
func (autoStorageBaseProperties *AutoStorageBaseProperties) AssignPropertiesToAutoStorageBaseProperties(destination *v1alpha1api20210601storage.AutoStorageBaseProperties) error {
	...
	if autoStorageBaseProperties.NodeIdentityReference != nil {
		...
		if err != nil {
			return errors.Wrap(err, "populating NodeIdentityReference from NodeIdentityReference, calling AssignPropertiesToComputeNodeIdentityReference()")
		}
...
func (autoStoragePropertiesStatus *AutoStorageProperties_Status) AssignPropertiesFromAutoStoragePropertiesStatus(source *v1alpha1api20210601storage.AutoStorageProperties_Status) error {
	...
	if source.NodeIdentityReference != nil {
		...
		if err != nil {
			return errors.Wrap(err, "populating NodeIdentityReference from NodeIdentityReference, calling AssignPropertiesFromComputeNodeIdentityReferenceStatus()")
		}
		autoStoragePropertiesStatus.NodeIdentityReference = &nodeIdentityReference
	} else {
...
func (autoStoragePropertiesStatus *AutoStorageProperties_Status) AssignPropertiesToAutoStoragePropertiesStatus(destination *v1alpha1api20210601storage.AutoStorageProperties_Status) error {
	...
	if autoStoragePropertiesStatus.NodeIdentityReference != nil {
		...
		if err != nil {
			return errors.Wrap(err, "populating NodeIdentityReference from NodeIdentityReference, calling AssignPropertiesToComputeNodeIdentityReferenceStatus()")
		}
		destination.NodeIdentityReference = &nodeIdentityReference
	} else {
		destination.NodeIdentityReference = nil
...
func (batchAccountIdentityStatus *BatchAccountIdentity_Status) AssignPropertiesFromBatchAccountIdentityStatus(source *v1alpha1api20210601storage.BatchAccountIdentity_Status) error {
	...
	if source.UserAssignedIdentities != nil {
		...
		for userAssignedIdentityKey, userAssignedIdentityValue := range source.UserAssignedIdentities {
			...
			if err != nil {
				return errors.Wrap(err, "populating UserAssignedIdentities from UserAssignedIdentities, calling AssignPropertiesFromUserAssignedIdentitiesStatus()")
			}
...
func (batchAccountIdentityStatus *BatchAccountIdentity_Status) AssignPropertiesToBatchAccountIdentityStatus(destination *v1alpha1api20210601storage.BatchAccountIdentity_Status) error {
	...
	if batchAccountIdentityStatus.UserAssignedIdentities != nil {
		...
		for userAssignedIdentityKey, userAssignedIdentityValue := range batchAccountIdentityStatus.UserAssignedIdentities {
			...
			if err != nil {
				return errors.Wrap(err, "populating UserAssignedIdentities from UserAssignedIdentities, calling AssignPropertiesToUserAssignedIdentitiesStatus()")
			}
			userAssignedIdentityMap[userAssignedIdentityKey] = userAssignedIdentity
		}
